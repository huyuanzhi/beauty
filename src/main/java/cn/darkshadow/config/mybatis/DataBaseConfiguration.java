...
public class DataBaseConfiguration implements EnvironmentAware {
	...
	public DataSource dataSource() {
		log.debug("Configrating DataSource");
		...
		config.setMinimumIdle(Integer.valueOf(propertyResolver.getProperty("maximumPoolSize")));
		...
		if ("com.mysql.jdbc.jdbc2.optional.MysqlDataSource"
			...
			config.addDataSourceProperty("maximumPoolSize",
					propertyResolver.getProperty("maximumPoolSize"));
		}
